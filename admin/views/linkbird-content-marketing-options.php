<div class="wrap">
    ...
    <form method="post" id="lbcm_admin">
        <p class="lbcm_help">
            <?php _e( 'Tragen Sie hier bitte Ihren linkbird Installations Token ein:', 'linkbird-content-marketing' ); ?>
        </p>

        <textarea type="text" placeholder="<?php _e( 'linkbird Installations Token', 'linkbird-content-marketing' ); ?>"
