<div class="notice notice-error is-dismissible">
    <?php if ( !empty( $setup_notice ) ) : ?>
        <p>
            <strong><?php echo __( 'Vielen Dank für die Installation des "linkbird Content Marketing" Plugins!', 'linkbird-content-marketing' ); ?></strong>
        </p>
        <p>
            <?php echo sprintf(
    ...
    <?php else: ?>
        <p>
            <strong><?php echo __( 'Das Plugin "linkbird Content Marketing" hat Probleme festgestellt:', 'linkbird-content-marketing' ); ?></strong>
        </p>
